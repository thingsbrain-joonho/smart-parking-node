...
router.get('/', function (req, res) {
    ...
    if (!sess.user_id) {
        ...
        if (sess.role == '0' || sess.role == '1') {
            ...
            sql1 += "select * from PK_MASTER where park_id=" + pk_id + "; ";
                ...
                connection.query(sql2, function (err, rows, fields) {
                    ...
                    connection.query(sql3, function (err, result, fields) {
                        ...
                        res.render('park', {
                            ...
                            pk_name: row_master['park_name'],
                            pk_location: row_master['location'],
                            w_start_time: row_master['weekday_start_time'],
                            w_end_time: row_master['weekday_end_time'],
                            s_start_time: row_master['sat_start_time'],
                            s_end_time: row_master['sat_end_time'],
                            h_start_time: row_master['holiday_start_time'],
                            h_end_time: row_master['holiday_end_time'],
                            row_use: row_use,
